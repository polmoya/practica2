...
glm.fitToM2 <- glm(DEATH_EVENT ~ age + creatinine_phosphokinase + ejection_fraction + platelets + serum_creatinine + serum_sodium + time, data = heart_data, family = binomial)
#Obtenim el valor estimat, l'error standard, el z-score i el p-value dels coeficients.
summary(glm.fitToM2)
...
glm.fitToM3 <- glm(DEATH_EVENT ~ age + creatinine_phosphokinase + ejection_fraction + platelets + serum_creatinine + serum_sodium + time + anaemia + diabetes + smoking + high_blood_pressure, data = heart_data, family = binomial)
#Obtenim el valor estimat, l'error standard, el z-score i el p-value de cadascun dels coeficients.
summary(glm.fitToM3)
#Obtenim els predictors, com la nostre variable resposta és dicotómica ho indiquem amb el paràmetre [type="response"]
...
```{r message= FALSE, warning=FALSE}
newData1 <- data.frame(age = 0.63636364, anaemia = "Si", creatinine_phosphokinase = 0.071319214, diabetes = "Si", ejection_fraction = 0.09090909, high_blood_pressure = "Si", platelets = 0.29082313, serum_creatinine = 0.15730337, serum_sodium = 0.48571429, sex = "femeni", smoking = "Si", time = 0.000000000)
predict(glm.fitToM3, newData1)
glm.fitToM5 <- glm(DEATH_EVENT ~ age + creatinine_phosphokinase + ejection_fraction + platelets + serum_creatinine + serum_sodium + time + anaemia + diabetes + smoking + high_blood_pressure, data = heart_data, family = binomial)
...
Hem anat observant els resultats amb taules i gràfiques al llarg de tot l'ànalisi.
-->
